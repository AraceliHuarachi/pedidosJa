...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines contain the Spanish translations of the default
    | error messages used by the validator class. Some of these rules have multiple
    | versions, such as the size rules. Feel free to tweak each of these messages here.
    |
    */
